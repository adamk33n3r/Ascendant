...
namespace Assets.Ascendant.Scripts {
    public class AnchorTool {
        ...
        [MenuItem("GameObject/Set Anchors to Transform", false, 49)]
        public static void Init() {
            selectedGameObject = Selection.activeGameObject;

            ownRectTransform = selectedGameObject.GetComponent<RectTransform>();
            parentRectTransform = selectedGameObject.transform.parent.gameObject.GetComponent<RectTransform>();
