...
internal sealed class ScriptKeywordProcessor : UnityEditor.AssetModificationProcessor {
	...
	private const string company = "Adam Keenan";
	private const string websiteUrl = " - http://adam-keenan.com";
	...
	public static void OnWillCreateAsset(string path) {
		...
		string prePath = "Assets/Ascendant/Scripts/";
		string namespaceText = path.Substring(prePath.Length);
		namespaceText = System.IO.Path.GetDirectoryName(namespaceText).Replace('/', '.');
		...
		var websiteString = (PlayerSettings.companyName == company ? websiteUrl : null);
